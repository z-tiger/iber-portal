...
public class LongRentOrderTimeOutSupport extends QuartzJobBean{
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		log.info("取消长租定时任务开始执行") ;
		StringBuffer sb = new StringBuffer("{") ;
		sb.append("\"cId\":\"platForm\",\"memberId\":\"\",\"method\":\"requestCancelLongRentOrderQuartz\",") ;
		sb.append("\"param\":\"{}\",") ;
		...
		log.info("取消长租定时任务结束执行" + jsonObject) ;
	}
