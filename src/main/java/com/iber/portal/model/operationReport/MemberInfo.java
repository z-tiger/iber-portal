...
public class MemberInfo {
	...
	private Integer timeRentUserTotal;
	
	private Integer dayRentUserTotal;
	
	private Integer chargingTotal;
	...
	public Integer getTimeRentUserTotal() {
		return timeRentUserTotal;
	}

	public void setTimeRentUserTotal(Integer timeRentUserTotal) {
		this.timeRentUserTotal = timeRentUserTotal;
	}

	public Integer getDayRentUserTotal() {
		return dayRentUserTotal;
	}

	public void setDayRentUserTotal(Integer dayRentUserTotal) {
		this.dayRentUserTotal = dayRentUserTotal;
	}

	public Integer getChargingTotal() {
		return chargingTotal;
	}

	public void setChargingTotal(Integer chargingTotal) {
