...
public final class MD5
{
    ...
    private static void md5Update(byte abyte0[],int i)
    {
        ...
        if ((count[0] += i << 3) < (long) (i << 3)) count[1]++;
        count[1] += i >>> 29;
        int l = 64 - k;
        int j;
        if (i >= l)
    ...
    public static String toMD5(String s)
    {
        ...
        digestHexStr = "";
        for (int i = 0; i < 16; i++)
            digestHexStr = digestHexStr
                    + byteHEX(digest[i]);

        return digestHexStr;
    }

    public final static String MD5toUpper32(String s, String encodingType) {
    ...
    public static void main(String[] args) {
        String str = "hekoll";
        System.out.println(MD5toUpper32(str, "utf-8"));
        System.out.println(MD5toUpper32(str,"utf-8").length());
