...
public class WXHttpsRequest {
   ...
   private Logger log = Logger.getLogger(WXHttpsRequest.class);
    ...
    public WXHttpsRequest() throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
        init();
    }
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        InputStream instream = WXHttpsRequest.class.getResourceAsStream("/apiclient_cert.p12");
        try {
            keyStore.load(instream, WXConfig.MCH_ID.toCharArray());//设置证书密码
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore, WXConfig.MCH_ID.toCharArray())
                .build();
     ...
     */
    public void setSocketTimeout(int socketTimeout1) {
     ...
     */
    public void setRequestConfig(RequestConfig requestConfig1) {
