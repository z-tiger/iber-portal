...
<title>当前订单列表</title>
    ...
    <script type="text/javascript" src="monitorCenter/thirdParty.js"></script>
	<!-- 高德地图 -->
...
// 				map : mapObj,
       ...
       if(carArrList.length > 0) {
          ...
          for ( var i = 0; i < carArrList.length; i++) {
               _subContentHtml += "<dl><dt>"+carArrList[i].lpn+"</dt>";
               _subContentHtml += "<dd >";
               _subContentHtml +="<a class=myButton href=\"javascript:queryCarRunInfo('"+carArrList[i].lpn+"');\">运行信息</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
