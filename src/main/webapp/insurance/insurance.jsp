		...
		$(function() {
			...
			$("#btnExport").bind("click", function() {
				...
				$("#insuranceForm").form("submit", {
					url : "export_insurance_list?insurance_no="
											+ insurance_no + "&lpn=" + lpn
											+ "&insurance_company="
											+ insurance_company
											+ "&insurance_holder="
											+ insurance_holder
			...
			$("#btnYjQuery").bind(
					"click",
					function() {
						var insurance_no = $("input[name='_insurance_no']")
								.val();
						var lpn = $("input[name='_lpn']").val();
						var insurance_company = $(
								"input[name='_insurance_company']").val();
						var insurance_holder = $(
								"input[name='_insurance_holder']").val();
						var insurance_type = $("input[name='_insurance_type']")
								.val();
						var queryDateFrom = $("input[name='queryDateFrom']")
								.val();
						var queryDateTo = $("input[name='queryDateTo']").val();
						$('#dataGrid').datagrid('load', {
							insurance_no : insurance_no,
					...
					.bind(
							...
							function() {
								...
								if (selectedRow.length <= 0) {
									$.messager.alert("提示", "请选择要编辑的保险信息保险 ",
											"error");
								} else {
									...
									$("#insurance_company").combobox(
											"setValue",
											JsonData.insuranceCompany);
									$("#insurance_type").combobox("setValue",
											JsonData.insuranceType);
									$("#insurance_no").textbox("setValue",
											JsonData.insuranceNo);
									$("#insurance_money").numberspinner(
											"setValue",
											(JsonData.insuranceMoney / 100)
													.toFixed(2));
									$("#insurance_holder").textbox("setValue",
											JsonData.insuranceHolder);
									$("#start_time").datebox("setValue",
											JsonData.startTime);
									$("#end_time").datebox("setValue",
											JsonData.endTime);
									$("#insurance_range").textbox("setValue",
											JsonData.insuranceRange);
