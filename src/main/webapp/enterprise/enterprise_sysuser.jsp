...
<head>
	...
	<script type="text/javascript" src="enterprise/enterprise_sysuser.js"></script>
</head>--%>
<%@ page language="java" pageEncoding="utf-8"%>
<html>
<head>
...
<body>
	...
	<div id="toolbar" style="height:auto">
		...
		登陆账号:<input  id="LoginUAcc" name="LoginUAcc"  class="easyui-textbox">
		姓名:<input  id="LoginUName"  name="LoginUName" class="easyui-textbox">
		企业名称:<input  id="enterpriseName"  name="enterpriseName" class="easyui-textbox">
...
<!-- 	<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-remove" plain="true" id="btnResetPwd" onclick=";">重置密码</a> -->
	...
	<div id="sysUserView" class="easyui-dialog" closed="true"
		...
		<form id="sysUserForm" method="post" action=""
			...
			<div class="fitem">
				<label>密码:</label>
                <input  name="password" id="password" type="password"  class="easyui-textbox"  	required="true"  missingMessage="请确认密码" style="width: 75%;"/>
			</div>
			 <div class="fitem">
                <label>确认密码:</label>
	       ...
	       <div class="fitem">
            ...
            <div class="fitem">
                <label>所属企业:</label>
                <input class="easyui-combobox" name="enterpriseId"
                       data-options=" url:'/getAllEnterpriseList',
                       editable:false,
	                    method:'get',
	                    valueField:'enterpriseId',
	                    textField:'enterpriseName',
	                    panelHeight:'auto'"
                       required="true" id="enterprisId" missingMessage="请选择所属企业" style="width: 75%;">
            </div>
			<div class="fitem">
            ...
            <div class="fitem">
                ...
                <input class="easyui-combobox" name="enterpriseId"
                       data-options=" url:'/getAllEnterpriseList',
	                    ...
	                    textField:'enterpriseName',
	                    panelHeight:'auto'"
                       required="true" id="enterprise_id" missingMessage="请选择所属企业" style="width: 75%;">
            </div>
