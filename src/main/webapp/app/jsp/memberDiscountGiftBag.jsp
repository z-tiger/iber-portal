  		...
  		<ul id="links" style="background-color: white;width: 103%; margin: 0 auto;padding-left: 0px;position:relative;left:-5px;height:80%;" >
  			<li style="list-style-type: none; height: 118px;">
  				...
  				<ul style="list-style-type: none;">    
  					<li style="font-size: 18px; color: #333333; margin-top: 18px; margin-left:-1px; position: relative; top: -45px">折扣大礼包</li>
  				</ul> 
  			</li>
  			...
  			<li style="list-style-type: none; height: 480px;margin-top: -10px;">
  				...
  				<ul style="text-align:justify; text-justify:inter-ideograph; position: relative; left: -1px; margin-top: -20px; font-size: 26px;margin-right: 10px;line-height:2.0;">
  					<li style="font-size: 10px; color: #666666;list-style:disc;">四星、五星会员进行租车消费时享有折扣优惠。</li>
  					<li style="font-size: 10px; color: #666666;list-style:disc;">会员等级变化，会员享受的折扣大礼包权益也会相应发生变化。</li>
  					<li style="font-size: 10px; color: #666666;list-style:disc;">会员支付时，自动根据会员享有的折扣大礼包权益对订单进行折扣优惠。</li>
  					<li style="font-size: 10px; color: #666666;list-style:disc;">
						不同等级的会员享受折扣大礼包权益为：<br/>
						一星会员消费金额将提升20%<br/>
						四星会员享受消费金额95折;<br/>
  						五星会员享受消费金额9折;<br/>
  					</li>
