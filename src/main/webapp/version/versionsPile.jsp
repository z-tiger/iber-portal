...
<head>
	...
	<script type="text/javascript" src="version/versionsPile.js"></script>
...
<body style="width:100%;height:100%;">
	...
	<div id="toolbar" style="height:auto">
			 ...
			 <input class="easyui-combobox"  id="categoryCode" name="categoryCode" style="height:24px" data-options="
		                    valueField:'value',
		                    textField:'label',
		                    data: [{
								label: '直流',
		                    ...
		                    panelHeight:'auto'">
			<!--  <input class="easyui-combobox" name="categoryCode" id="categoryCode"  
			 
			 		data-options="editable:false,valueField:'code',textField:'name',url:'queryCategory',panelHeight:'160'">  -->
			 <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" plain="true" id="btnQuery">查询</a>
			<r:FunctionRole functionRoleId="add_pile_version">
				<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-add" plain="true" id="btnAdd">添加</a>
			</r:FunctionRole> 
			<r:FunctionRole functionRoleId="update_pile_version">
				<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-edit" plain="true" id="btnEdit">修改</a>
			</r:FunctionRole> 
			<r:FunctionRole functionRoleId="delete_pile_version">
...
<!-- 		    			<input class="easyui-combobox" name="categoryCode" id="categoryCode"  data-options="required:true,valueField:'code',textField:'name',url:'queryCategory',panelHeight:'160'">
 -->		    			
 						<input class="easyui-combobox"  id="code" name="categoryCode" style="height:24px" data-options="required:true,
		                    valueField:'value',
		                    textField:'label',
		                    data: [{
								label: '直流',
