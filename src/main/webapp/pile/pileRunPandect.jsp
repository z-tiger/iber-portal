   ...
   <!-- 标题部分 -->
	...
	<div id="middle">
		<div id="middle-left"> <!-- 左侧整体布局 -->
	    	...
	    	<div id="middle-carStatus" class="bkwhite" style="margin-right:20px;">
	    		<span id="sp6"><span id="sp16">服务类型</span></span>
	    	</div>
	    	<div id="middle-memberLevel" class="bkblue" style=" width:96px;height:40px;border:1px solid #79c1f2;float:right;margin-top:9px;">
	    		<span id="sp6"><span id="sp22">桩类型</span></span>
	    	</div>
		...
		<div id="middle-right"><!-- 右侧整体布局 -->
	    	...
	    	<div id="middle-right-carType" class="bkwhite" style="margin-right:20px;">
	    		<span id="sp5"><span id="sp18">枪状态</span></span>
	    	</div>
	    	<div id="middle-right-expenseType" class="bkblue">
	    		<span id="sp5"><span id="sp23">枪类型</span></span>
	    	</div>
	 ...
	 <div id="foot-member" >
	 	<div id="foot-member-title" ><!-- 条件筛选栏 -->
	 		...
	 		<div id="checkboxs">
				...
				<span class="checkboxStyle">
	 			<input type="radio" name="radio2" id="radioOrderType2" value="1" style="margin-left:10px" />
	 				订单类型
	 			<input class="easyui-combobox" name="memberOrderList2" id="memberOrderList2" style="width:100px; margin-right:22px"
					data-options="
					    valueField: 'value',
						textField: 'label',
						panelHeight:'auto',
	 	...
	 	<div id="foot-body"><!-- 数据展示区域 -->
	 		<div id="memberCharacterArea"><!-- 文字图片说明区 -->
	 			...
	 			<div id="member_characterArea_left" ><!-- 左 -->  
	 				<a href="javascript:void(0);" onclick="setPileLineOptions(0);" />
	 				...
	 				<div  style="margin-top:16px;margin-left:70px;">
	 			 		<span id="ratioDayCnt_member" style="margin-left:140px;font-size:40px;font-weight:bold;color:green;white-space: nowrap;"></span>
	 			 	</div>
	 			</div>
	 			<div  id="member_characterArea_middle" ><!-- 中-->
	 				<a href="javascript:void(0);" onclick="setPileLineOptions(1);" />
	 				<div  style="margin-top:15px;margin-left:70px;">
	 				...
	 				<div  style="margin-top:16px;margin-left:70px;">
	 			 		<span id="ratioMonthCnt_member" style="margin-left:140px;font-size:40px;font-weight:bold;color:green;white-space: nowrap;"></span>
	 			 	</div>
	 			</div>
	 			<div id="member_characterArea_right"><!-- 右 -->
	 				...
	 				<div  style="margin-top:15px;margin-left:70px;">
	 			 		...
	 			 		<span id="totalCnt_member" style="margin-left:50px;font-size:26px;font-weight:bold;color:white;position:relative;top:20px;"></span><span style="font-size:13px;font-weight:bold;color:white;position:relative;top:20px;"class="unit"></span>
	 			 	</div>
	 			 	<div   style="margin-top:0px;margin-left:70px;">
	...
	<script type="text/javascript" src="echarts/asset/js/run_statistics_echarts_pile.js"></script>
</body>
</html>