...
<head>
	...
	<script type="text/javascript" src="rescuer/rescuer.js"></script>
	<style type="text/css">
		/*.ftitle {
			font-size: 14px;
			font-weight: bold;
	...
	<body>
		<table id="dataGrid" toolbar="#toolbar"></table>
 	    ...
 	    <form action="" id="rescuerForm">
			...
			救援员名称:<input id="rescuerName"  name="rescuerName" class="easyui-textbox" style="width:150px"/>
			...
			<r:FunctionRole functionRoleId="export_rescure">
		...
		<div id="addView" class="easyui-dialog" closed="true" style="padding:10px 50px">
			   ...
			   <div class="fitem">
			   		<tr>
			   			<td>姓名:&nbsp;&nbsp;</td>
			   			<td>
			   				<input class="easyui-textbox" name="rescuerName" id="e-rescuerName" style="width: 30%;"  required="true"  missingMessage="请填写姓名"/>
		                </td>
		                <td>手机号:&nbsp;</td>
		...
		<div id="editView" class="easyui-dialog" closed="true" style="padding:10px 50px">
	           ...
	           <input type="hidden" name="ed-id" id="edit-id">
			   <div class="fitem">
			   		<tr>
			   			<td>姓名:&nbsp;&nbsp;</td>
			   			<td>
			   				<input class="easyui-textbox" name="ed-rescuerName" id="edit-rescuerName" style="width: 30%;"  required="true"  missingMessage="请填写姓名"/>
		                </td>
		                <td>手机号:&nbsp;</td>
		            ...
		            <br><br>
			   		<tr>
			   			<td>性别:&nbsp;&nbsp;</td>
			   			<td><input class="easyui-combobox" name="ed-sex" id="edit-sex" data-options=" 
			   				valueField:'id',
		                    textField:'text',
		                     panelHeight:'auto',
		                     required:true,
		            ...
		            <br><br>
			   		<tr>
			   			<td>身份:&nbsp;&nbsp;</td>
			   			<td><input class="easyui-combobox" name="ed-identy" id="edit-identy" data-options=" 
			   				valueField:'id',
		                    textField:'text',
		                    required:true,
		                     panelHeight:'auto',
			   			...
			   			<td>&nbsp;&nbsp;&nbsp;工种:&nbsp;&nbsp;&nbsp;</td>
			   			<td><input class="easyui-combobox" name="ed-worker" id="edit-worker" data-options=" 
			   				valueField:'id',
		                    textField:'text',
		                     panelHeight:'auto',
		                    data:[{   
						...
						<td>&nbsp;&nbsp;&nbsp;&nbsp;邮箱:&nbsp;&nbsp;&nbsp;</td>
						<td><input class="easyui-textbox" name="email" id="edit-email"   style="width: 125px" required="true"  missingMessage="请填写邮箱"/>
						</td>
		            </tr>
		            <br/><br/>
		            <tr>
		            	<td>类型：</td>
		            	<td>
		            		<input class="easyui-combobox" name="ed-type" id ="edit-type" data-options="
		            		valueField:'id',
		                    textField:'text',
		                    required:true,
		                    panelHeight:'auto',
		            ...
		            <tr>
			   			<td>特别说明:</td>
			   			<td>
			   				<input class="easyui-textbox" data-options="multiline:true" name="ed-specialComment" id="edit-specialComment" style="width: 75%;height: 50%;"></textarea>
			   			</td>
		            </tr>
			   </div>
	       </form>
