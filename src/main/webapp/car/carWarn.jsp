...
<!-- 高德地图 -->
<script language="javascript" src="http://webapi.amap.com/maps?v=1.3&key=a22fc1682b40fc7774e90ee30fa36466"></script>
<script type="text/javascript" src="car/carWarn.js"></script>
<style type="text/css">
.ftitle {
	font-size: 14px;
	font-weight: bold;
...
<body>
   <table id="carWarnGrid" toolbar="#toolbar"></table>
   <!-- 工具栏 -->
