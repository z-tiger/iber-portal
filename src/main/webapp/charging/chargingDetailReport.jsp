...
<head>
	...
	<script type="text/javascript" src="charging/chargingDetailReport.js"></script>
...
<body>
	<div title="城市-充电站">
		...
		<div>
		<table id="chargingDetailGrid" toolbar="#toolbar" ></table>
		<div id="toolbar" class="fitem" style="height:auto">
			...
			<label name="label_quarter">第
		 	...
		 	<!-- 查询按钮 -->
            <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" plain="true" id="btnQueryDetail">查询</a>
         	<r:FunctionRole functionRoleId="export_charging_detail_Report">
