...
<head>
	...
	<script type="text/javascript" src="exception/exceptionLog.js"></script>
	...
	<body>
		<table id="dataGrid" toolbar="#toolbar"></table>
 	    ...
 	    <div id="toolbar" style="height:auto">
			方法:<input id="method"  name="method" />
			会员id:<input id="memberId"  name="memberId" />
			创建时间:<input id="queryDateFrom"  name="queryDateFrom" class="easyui-datetimebox s" />
